...
const VerifyOTP = () => {
    ...
    return (
        <HelmetProvider>
            <Helmet>
                <meta name="description" content="Tixhub, verify your OTP to connect with the best concerts, sports games, theater performances and festivals." />
                <meta property="og:description" content="Tixhub, verify your OTP to connect with the best concerts, sports games, theater performances and festivals." />
                <title>Verify OTP | Tixhub</title>
                </Helmet>
            <main>
