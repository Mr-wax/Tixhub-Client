...
const CreateEvent = () => {
    ...
    return (
        <HelmetProvider>
            <Helmet>
                <meta name="description" content="Tixhub, lets create the best of concerts, sports games, theater performances and festivals. Our mission is to make discovering, buying, and selling tickets easy and secure." />
                <meta property="og:description" content="Tixhub, lets create the best of concerts, sports games, theater performances and festivals. Our mission is to make discovering, buying, and selling tickets easy and secure." />
                <title>CreateEvent | Tixhub</title>
                </Helmet>
            <main>
