...
const SignUp = () => {
    ...
    const submitHandler = formData => {
        ...
        .then(data => {
            ...
            if (data.message === "User saved successfully") {
                setShowModal({
                    heading: "Success",
                    message: `${data.newUser.firstname}, your Tixhub account has been created, verify your account to create unforgettable experiences.`,
                    on: true,
                    success: true
                });
                ...
                setShowModal({
                    ...
                    message: `${data.user.firstname}, you already have a Tixhub account, sign in to create unforgettable experiences with ease and confidence.`,
                    on: true,
                    success: false
                });
                navigate("/sign-in");
    ...
    return (
        <HelmetProvider>
            <Helmet>
                <meta name="description" content="Tixhub, create an account and share a universe of exciting events – from electrifying concerts and thrilling sports games to captivating theater performances and vibrant festivals." />
                <meta property="og:description" content="Tixhub, create an account and share a universe of exciting events – from electrifying concerts and thrilling sports games to captivating theater performances and vibrant festivals." />
                <title>SignUp | Tixhub</title>
                </Helmet>
            <main>
